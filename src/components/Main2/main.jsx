        ...
        <div className={styles.layout}>
            ...
            <div className={styles.feedContainer}>
                ...
                <div className={styles.bottomBar}>
                    ...
                    <svg onClick={() => onOffModal()} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <svg onClick={() => onOffModal()}xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 27 27" fill="none" className={styles.bookmark}>
